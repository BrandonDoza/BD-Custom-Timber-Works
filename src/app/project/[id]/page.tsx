  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        />
        <p style={{ fontSize: "16px", marginBottom: "10px", color: "black" }}>{description}</p>
        <p style={{ fontWeight: "bold", fontSize: "16px", color: "black" }}>Size: {size}</p>
        <p style={{ fontWeight: "bold", fontSize: "18px", color: "black" }}>{price}</p>
